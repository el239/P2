                            ...
                            size_t k, const string & message)
{
    ...
    } else if(compare_spectrum(seq, seq_truth, k)) {
        cout << "Passed " << message <<
            " (assembled a sequence of the same spectrum with the original sequence). Congratulations!" << endl;
    } else {
...
static void test_1 (const string & method)
{
    ...
    // Example 0.
    seqs_truth.push_back("aaaaaaaaaaa");
    ks.push_back(5);
    
    // Example 1.
    seqs_truth.push_back("agcagctcagc");
    ks.push_back(3);

    // Example 2.
    seqs_truth.push_back("agcagctcagg");
    ks.push_back(3);

    // Example 3.
    seqs_truth.push_back(random_DNA_sequence(10000, 20000));
    ks.push_back(20);
